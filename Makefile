# This Makefile is for the Blitz extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Blitz.pm]
#     AUTHOR => q[Ben Klaas <ben@benklaas.com>]
#     LICENSE => q[perl]
#     NAME => q[Blitz]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Regexp::Common=>q[0], MIME::Base64=>q[0], JSON::XS=>q[2.3], LWP=>q[0] }
#     VERSION_FROM => q[lib/Blitz.pm]
#     clean => { FILES=>q[Blitz-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Blitz.pm \
	lib/Blitz/API.pm \
	lib/Blitz/Exercise.pm \
	lib/Blitz/Rush.pm \
	lib/Blitz/Sprint.pm \
	lib/Blitz/Validate.pm
...
PM_TO_BLIB = lib/Blitz/Rush.pm \
	blib/lib/Blitz/Rush.pm \
	lib/Blitz/API.pm \
	blib/lib/Blitz/API.pm \
	lib/Blitz/Validate.pm \
	blib/lib/Blitz/Validate.pm \
	lib/Blitz/Sprint.pm \
	blib/lib/Blitz/Sprint.pm \
	lib/Blitz/Exercise.pm \
	blib/lib/Blitz/Exercise.pm \
	lib/Blitz.pm \
	blib/lib/Blitz.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Blitz/Rush.pm $(INST_MAN3DIR)/Blitz::Rush.$(MAN3EXT) \
	  lib/Blitz/API.pm $(INST_MAN3DIR)/Blitz::API.$(MAN3EXT) \
	  lib/Blitz/Validate.pm $(INST_MAN3DIR)/Blitz::Validate.$(MAN3EXT) \
	  lib/Blitz/Sprint.pm $(INST_MAN3DIR)/Blitz::Sprint.$(MAN3EXT) \
	  lib/Blitz/Exercise.pm $(INST_MAN3DIR)/Blitz::Exercise.$(MAN3EXT) \
	  lib/Blitz.pm $(INST_MAN3DIR)/Blitz.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                Blitz' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            Perl module for API access to Blitz' >> META_new.yml
	$(NOECHO) $(ECHO) 'license:             perl' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:              ' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Ben Klaas <ben@benklaas.com>' >> META_new.yml
	$(NOECHO) $(ECHO) 'generated_by:        ExtUtils::MakeMaker version 6.42' >> META_new.yml
	$(NOECHO) $(ECHO) 'distribution_type:   module' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:     ' >> META_new.yml
	$(NOECHO) $(ECHO) '    JSON::XS:                      2.3' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl module for API access to Blitz</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Ben Klaas &lt;ben@benklaas.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="JSON-XS" VERSION="2,3,0,0" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Regexp-Common" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Blitz/Rush.pm blib/lib/Blitz/Rush.pm \
	  lib/Blitz/API.pm blib/lib/Blitz/API.pm \
	  lib/Blitz/Validate.pm blib/lib/Blitz/Validate.pm \
	  lib/Blitz/Sprint.pm blib/lib/Blitz/Sprint.pm \
	  lib/Blitz/Exercise.pm blib/lib/Blitz/Exercise.pm \
	  lib/Blitz.pm blib/lib/Blitz.pm 
